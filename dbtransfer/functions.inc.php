 ...
 * @return array
 */
function mf_dbtransfer_record_sql($table, $conditions, $extra_condition = '') {
	static $fields = [];
 ...
 * @return array
 */
function mf_dbtransfer_relations($table_name = '', $field_name = '') {
	static $relations;
	if (!$relations) {
 ...
 * @return array
 */
function mf_dbtransfer_translationfields() {
